...
export default function ComposeClient({
  ...
  async function handleSend(scheduleAt?: Date | null) {
    ...
    try {
      ...
      // Send email directly via Graph API
  ...
  return (
    <div className="flex flex-col flex-1 bg-background-200 relative" style={{ height: "100vh", overflow: "hidden" }}>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 flex items-start justify-center">
        <div
          className={`relative max-w-3xl w-full bg-background-50 rounded-large composer-shadow flex flex-col overflow-hidden transition-all ${isDragOver ? "border-2 border-primary-400 ring-2 ring-primary-100" : "border border-neutral-200"}`}
          style={{ height: "calc(100vh - 130px)", minHeight: 480, maxHeight: 860 }}
        ...
        >
          ...
          {/* FROM */}
          <div className="flex items-center gap-3 px-5 py-2 border-b border-neutral-100">
          ...
          {/* SUBJECT */}
          <div className="flex items-center gap-3 px-5 py-2 border-b border-neutral-200">
          ...
          {/* EMAIL BODY */}
          <div className="flex-1 overflow-y-auto px-6 py-4 bg-background-50 relative" style={{ minHeight: 0 }}>
          ...
          {/* FOOTER / SEND BAR */}
          <div className="flex items-center justify-between px-5 py-3 border-t border-neutral-200 bg-background-50 flex-shrink-0">
